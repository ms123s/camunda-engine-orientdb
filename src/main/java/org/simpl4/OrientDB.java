...
public class OrientDB {
	...
	private com.orientechnologies.orient.core.db.OrientDB orientDB;
	...
	public synchronized ODatabasePool getDatabasePool(String db,String username, String pw ) {
		if( orientDB == null){
			orientDB = new com.orientechnologies.orient.core.db.OrientDB("remote:192.168.2.155", "root", rootPassword, OrientDBConfig.defaultConfig());
		}
